         ...
         <!-- /post thumbnail -->
			...
			<!-- /post details -->
                ...
                ?>
                    ...
                    <P class="fecha">Duración:<span><?php echo $fechasalida;?> - <?php echo $fechaRetorno;?></P>
                    ...
                    <P>Lugar de salida:<span><?php the_field('precio');?></span></P>
                 
                </div>
                <h2 class="itinerario">Itinerario de viaje</h2>
                <?php the_field('itinerario_del_viaje');?>
			</article>
		<!-- /article -->
