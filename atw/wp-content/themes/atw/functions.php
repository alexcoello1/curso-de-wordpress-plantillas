...
if (function_exists('add_theme_support'))
{
    ...
    add_image_size('mediano', 350, 250, true); // Medium Thumbnail
    add_image_size('toursDestacado',705, 391, true); // toursdestacados
    add_image_size('toursPrincipal',751, 422, true); // toursPrincipales
    add_image_size('blogPrincipal',1100, 404, true); // BlogPrincipal
    add_image_size('slider',2000,600,true);//Slider
    add_image_size('miniatura',98, 66, true); // miniatura
    add_image_size('entradasIndex',250, 179, true); // EntradasHome
...
function html5blank_header_scripts()
{
    if ($GLOBALS['pagenow'] != 'wp-login.php' && !is_admin()) {
        ...
        wp_register_script('lightbox', get_template_directory_uri() . '/js/lightbox.js', array(), '2.11.1', true); // lightbox.js
        wp_enqueue_script('lightbox'); // Enqueue it!

        wp_register_script('bxslider', get_template_directory_uri() . '/js/jquery.bxslider.js', array(), '4.1.1', true); // bxslider.js
...
function html5blank_styles()
{
    ...
    wp_register_style('lightbox', get_template_directory_uri() . '/css/lightbox.css', array(), '2.7', 'all');
    wp_enqueue_style('lightbox'); // Enqueue it!

    wp_register_style('bxslidercss', get_template_directory_uri() . '/css/jquery.bxslider.css', array(), '4.1.1', 'all');
    wp_enqueue_style('bxslidercss'); // Enqueue it!
    wp_register_style('slicknav', get_template_directory_uri() . '/js/jquery.slicknav.min.js', array(), '1.0.10', 'all');
    wp_enqueue_style('slicknav'); // Enqueue it!
    wp_register_style('oxygen','https://fonts.googleapis.com/css?family=Oxygen&display=swap',array(),'1.0','all' );
...
if (function_exists('register_sidebar'))
{
    ...
    register_sidebar(array(
        ...
        'description' => __('Agregue aquì sus cupones(máximo 2)', 'html5blank'),
        'id' => 'widget-area-1',
...
// Create 1 Custom Post type for a testimoniales o, called HTML5-Blank
function testimoniales_posttype()
{
    ...
    register_post_type('testimoniales', // Register Custom Post Type
        ...
        'labels' => array(
            ...
            'view' => __('View Testimonial Post', 'html5blank'),
            'view' => __('View Testimonial Post', 'html5blank'),
            'view' => __('View Testimonial Post', 'html5blank'),
            'view_item' => __('View Testimonial', 'html5blank'),
            'view' => __('View Testimonial Post', 'html5blank'),
            'search_items' => __('Search Testimonial Post', 'html5blank'),
            'not_found' => __('No Testimonial found', 'html5blank'),
            'view' => __('View Testimoniales Post', 'html5blank'),
...
function slider_posttype()
{
    ...
    register_post_type('slider', // Register Custom Post Type
        ...
        'labels' => array(
            ...
            'view' => __('View slider Post', 'html5blank'),
            'view' => __('View slider Post', 'html5blank'),
            'view' => __('View slider Post', 'html5blank'),
            'view_item' => __('View slider', 'html5blank'),
            'view' => __('View slider Post', 'html5blank'),
            'search_items' => __('Search slider Post', 'html5blank'),
